...
.env.example). Local-infra values (DB URL, JWT secret, Milvus) carry dev
defaults so `uvicorn app.main:app` boots with zero config.
"""
...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+psycopg://carecart:carecart@localhost:5432/carecart"
