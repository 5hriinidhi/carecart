      ...
      child: ListView(
        ...
        children: [
          ...
          async.when(
            ...
            data: (r) => switch (r) {
              ...
              MedicationsLoaded(:final items) when items.isEmpty => _note(
                  'No medications on file. Add them during setup or here so scans '
                  'can cross-check against them.'),
          ...
          Container(
            ...
            child: Text(
              'Stored encrypted on device. Nothing leaves the phone without you '
              'saying so — and you can delete all of it in one tap from your '
              'profile.',
